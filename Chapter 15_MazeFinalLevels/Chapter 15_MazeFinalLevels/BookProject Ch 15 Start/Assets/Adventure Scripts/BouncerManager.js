...
function ProcessWeapons (index : int) {
   ...
   var pos : Vector3 = dropPoint.transform.position; 
   var rot : Vector3 = dropPoint.transform.localEulerAngles; 
   ...
   weapons[index].transform.localPosition = pos;
weapons[index].transform.position = pos;
   weapons[index].transform.localEulerAngles = rot;
